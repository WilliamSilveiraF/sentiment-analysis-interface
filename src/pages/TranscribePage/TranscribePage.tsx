...
export default function TranscribePage() {
    ...
    return <div className='TranscribePage'>
      <div className="TranscribePage-container">
        <div className="TranscribePage-container-body">
          <h2 className="TranscribePage-container-title">Upload a file</h2>
          <p className="TranscribePage-container-description">Attach the file below</p>
          <button 
            className="TranscribePage-upload-area" 
            onClick={handleUploadClick}
            onDragOver={handleDragOver}
            onDrop={handleDrop}
          >
            <span className="TranscribePage-upload-area-icon">
            ...
            <span className="TranscribePage-upload-area-title">Drag file(s) here to upload.</span>
            <span className="TranscribePage-upload-area-description">
